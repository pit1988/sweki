...
Ad oggi gli appunti sono incompleti ma cercherò di migliorarli (ultime parole famose).
	...
	\item riuso: l'IS è un insieme di best practices che assembla cose già esistenti, più che crearle ex novo. % riuso è un processo..? forse è da togliere
	...
	\subsection{Attività fondamentali di un processo software}
	...
	\item definizione delle specifiche del software;
			
	\item progetto e implementazione del software;
			
	\item validazione del software;
