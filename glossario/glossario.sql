...
("processo_standard", "processo standard", "riferimento di base generico usato come stile comune per lo svolgimento delle funzioni aziendali, pensato per una collettività di casi afferenti ad un certo dominio applicativo", NULL),
...
("ciclo_di_vita", "ciclo di vita (di un prodotto)", "insieme degli stati che il prodotto assume, dal concepimento al ritiro", "life cycle"),
("ritiro", "ritiro (di un prodotto)", "momento in cui il prodotto cessa di essere seguito dai suoi creatori", "retirement"),
("fase_di_ciclo_di_vita", "fase (di un ciclo di vita)", "durata temporale entro uno stato del ciclo di vita e un altro", "phase"),
