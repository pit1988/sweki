...
foreach ($termini as $t) {
	...
	$gloss_php .= "\n\t\t\t<dt id=\"" . htmlentities($t['id']) . "\">" . htmlentities($t['voce']) . "</dt>\n
		\t\t\t<dd>" . (html_entity_decode($t['def'])) . html_eng($t['eng'], $t['voce']) . "</dd>
		\t\t<dd><dd><a href='voce.php?id=" . htmlentities($t['id']) . "'>modifica</a>; <a href='glossario.php?id=" . htmlentities($t['id']) . "'>rimuovi</a></dd>";
	$gloss_html .= "\n\t\t\t<dt id=\"" . htmlentities($t['id']) . "\">" . htmlentities($t['voce']) . "</dt>\n
